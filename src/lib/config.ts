...
const envSchema = z.object({
  ...
  AUTOPILOT_TOP_UP_AUTO_ENABLED: z
    .string()
    .optional()
    .default("false")
    .transform((value) => value === "true" || value === "1"),
  AUTOPILOT_TOP_UP_AUTO_MIN_USD: z.coerce.number().min(0).optional().default(25),
  AUTOPILOT_TOP_UP_AUTO_MIN_EFFICIENCY_BPS: z.coerce.number().int().min(0).max(10_000).optional().default(8_500),
  AUTOPILOT_TOP_UP_AUTO_MIN_BOUNDARY_DISTANCE_TICKS: z.coerce.number().int().min(0).optional().default(30),
  AUTOPILOT_TOP_UP_AUTO_MAX_GAS_COST_USD: z.coerce.number().min(0).optional().default(0.2),
